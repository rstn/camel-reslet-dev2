...
public class RestletEndpoint extends DefaultEndpoint implements HeaderFilterStrategyAware {
    ...
    public RestletEndpoint(PSRestletComponent component, String remaining) {
        super(remaining, component);
    }

    @Override
    public int hashCode() {
        return getEndpointUri().hashCode() * 3 + 3;
    }

    @Override
    public boolean equals(Object object) {        
        if (object.getClass() == getClass()) {
            RestletEndpoint that = (RestletEndpoint)object;
